...
@Data
@Entity
@Table(name = "ses_m25_emp_attendance_logs")
public class SupraEmpAttendanceLogs {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "ATTN_RF_NUM")
    private Long attnrfnum;
    ...
    @Column(name = "LAST_MODI_TIME", nullable = false, columnDefinition = "TIMESTAMP DEFAULT CURRENT_TIMESTAMP")
    private LocalDateTime lastModiTime;

    @Column(name = "DEVICE_ID", nullable = false, columnDefinition = "VARCHAR(50) DEFAULT '1'")

package com.atomicnorth.hrm.tenant.domain.language;
...
@Data
@Entity
@Table(name = "ses_m00_languages")
public class SupraLanguageEntity {
    ...
    @Column(name = "OPERATION_SOURCE", nullable = true, length = 50)

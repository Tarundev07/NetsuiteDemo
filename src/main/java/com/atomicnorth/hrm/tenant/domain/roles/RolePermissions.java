...
@Table(name = "ses_m00_role_permissions")
public class RolePermissions implements Serializable {
    ...
    @ManyToOne  // Establishing the relationship with Role
    ...
    @ManyToOne
    @JoinColumn(name = "MODULE_FUNCTION_ID", insertable = false, updatable = false)
    private FunctionEntity moduleFunction;

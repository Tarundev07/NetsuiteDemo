...
@Data
@Table(
        name = "ses_m04_emp_separation",
        uniqueConstraints = {@UniqueConstraint(columnNames = "EMPLOYEE_ID")}
)
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class EmpSeparation implements Serializable {

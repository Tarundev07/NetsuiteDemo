...
import com.atomicnorth.hrm.util.LongListConverter;
...
public class Interview implements Serializable {
    ...
    @Column(name = "INTERVIEW_ROUND_ID", nullable = false)
    private Long interviewRoundId;
    @Column(name = "INTERVIEWER_ID", columnDefinition = "json")
    @Convert(converter = LongListConverter.class) // Custom Converter for JSON storage
    ...
    @Column(name = "INTERVIEW_SCHEDULED_DATE", nullable = false)

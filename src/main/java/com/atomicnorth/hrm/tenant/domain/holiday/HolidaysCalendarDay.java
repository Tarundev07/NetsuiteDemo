...
@Entity
@Table(name = "ses_m06_hoilday_calendar_days", uniqueConstraints = {
        @UniqueConstraint(name = "Index_2", columnNames = {"HOLIDAY_CALENDAR_ID", "HOLIDAY_DATE"})
})
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class HolidaysCalendarDay {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "HOLIDAY_CALENDAR_DAY_ID")
    ...
    // JSON-like attributes (J_ATTRIBUTE31 to J_ATTRIBUTE32)

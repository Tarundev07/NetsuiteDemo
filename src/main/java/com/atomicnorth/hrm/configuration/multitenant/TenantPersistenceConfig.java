...
@EnableJpaRepositories(
        basePackages = {"com.atomicnorth.hrm.tenant.repository"},
...
public class TenantPersistenceConfig {
    ...
    @Primary
    @Bean
    public LocalContainerEntityManagerFactoryBean tenantEntityManagerFactory(MultiTenantConnectionProvider connectionProvider, CurrentTenantIdentifierResolver tenantResolver) {
        LocalContainerEntityManagerFactoryBean emfBean = new LocalContainerEntityManagerFactoryBean();
//        emfBean.setPersistenceUnitName("tenant-persistence-unit");
        emfBean.setPackagesToScan("com.atomicnorth.hrm.tenant.domain");

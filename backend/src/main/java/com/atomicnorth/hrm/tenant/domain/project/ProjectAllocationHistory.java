...
@Data
@Entity
@Table(name = "ses_m02_project_allocation_history")
public class ProjectAllocationHistory {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "PROJECT_ALLOCATION_HISTORY_ID")
    ...
    @ManyToOne
    @JoinColumn(name = "PROJECT_RF_NUM", referencedColumnName = "PROJECT_RF_NUM", insertable = false, updatable = false)

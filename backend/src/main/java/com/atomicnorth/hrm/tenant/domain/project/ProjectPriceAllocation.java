...
@Data
@Entity
@Table(name = "ses_m02_project_resource_price_allocation")
public class ProjectPriceAllocation {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "PROJECT_RESOURCE_PRICE_ALLOCATION_ID")
    private Integer projectResourcePriceAllocation;
    ...
    private Double userWorkingDays;
    @Column(name = "ON_LEAVE")
    private Double onLeave;

...
@Data
@Entity
@Table(name = "ses_m02_price_group_element_mapping")
public class ProjectPriceMapping {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "PRICE_GROUP_AND_ELEMENT_ID")
    private Integer priceGroupAndElementId;
    ...
    private Integer lastUpdateSessiondId;

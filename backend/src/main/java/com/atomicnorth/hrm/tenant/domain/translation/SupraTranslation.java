package com.atomicnorth.hrm.tenant.domain.translation;
...
@Data
@Entity
@Table(name = "ses_m00_translation", uniqueConstraints = @UniqueConstraint(columnNames = {"language_id", "short_code"}))
public class SupraTranslation implements Serializable {

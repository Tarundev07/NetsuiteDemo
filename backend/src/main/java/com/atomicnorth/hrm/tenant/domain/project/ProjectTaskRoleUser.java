...
@Getter
@Entity
@Table(name = "ses_m02_project_task_role_user_mapping")
public class ProjectTaskRoleUser {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "PROJECT_TASK_ROLE_USER_ID")
    private Integer projectTaskRoleUserId;

    @Column(name = "PROJECT_TASK_ROLE_ID")
    private Integer projectTaskRoleId;

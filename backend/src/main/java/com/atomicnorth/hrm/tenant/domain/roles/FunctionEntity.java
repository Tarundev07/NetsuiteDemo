...
@Table(name = "ses_m00_module_function")
public class FunctionEntity implements Serializable {
    ...
    @Column(name = "MODULE_NAME_CODE_LANG")
  ...
  /*  @Column(name="modulenamecodelang")
    private Integer modulenamecodelang;

    @Column(name="displaynamecodelang")
    private Integer displaynamecodelang;*/

    @Column(name = "ENABLE_ON_MOBILE")
    private String enableonMobile;

    @Column(name = "ENABLE_ON_WEB")
    private String enableonWeb;


    @Column(name = "QUICK_APPLY_FLAG")
    private String quickapplyflag;


    @Column(name = "IS_REPORT_FLAG")
    private String isreportflag;

    @Column(name = "IS_WORKFLOW_ELIGIBLE")
    private String isWorkFlowEligible ;


    @Column(name = "IS_REQUEST_FLAG")
    private String isrequestflag;
    ...
    @Transient
    @JsonProperty
    private List<FeatureFunction> child;
}

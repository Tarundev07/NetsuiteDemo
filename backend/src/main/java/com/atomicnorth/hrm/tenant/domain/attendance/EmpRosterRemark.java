...
@Data
@Entity
@Table(name = "ses_m07_emp_roster_remark")
public class EmpRosterRemark {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "ROSTER_REMARK_ID")
    ...
    @Column(name = "ASSIGNEE_REMARK")
    private String assigneeRemark;

    @Column(name = "TEMP_LEAVE_FLAG", length = 50)

...
@Data
@Entity
@Table(name = "ehrms_tms_timesheet")
public class UserTaskMapping {
    ...
    @Column(name = "EFFORT_IN_HOURS")
    private String effortInHours;

    @Column(name = "BILLABLE_EFFORT_IN_HOURS")
    private Integer billableEffortInHours;
    ...
    @Column(name = "ACCOUNT_MANAGER_REMARK")
